...
print(f"Number of principal components to preserve 95% of variance: {num_components}")
...
scatter = plt.scatter(projected_data[:, 0], projected_data[:, 1], c=class_labels, cmap='viridis', alpha=0.7)
plt.colorbar(scatter, label='Class Label')
plt.xlabel('Principal Component 1')
plt.ylabel('Principal Component 2')
plt.title('Projection onto the Principal Components')
plt.show()

# Output some key results
...
print(remaining_eigenvalues_sum)
